...
local Carry = gui:newpage("Main")
Carry:addlabel("Main")

local hbe = nil
Carry:addcheckbox("HBE",false,function(b)
    if b then
        _G.HeadSize = 15
_G.Disabled = true
...
pcall(function()
v.Character.HumanoidRootPart.Size = Vector3.new(_G.HeadSize,_G.HeadSize,_G.HeadSize) v.Character.HumanoidRootPart.Transparency = 0.8
...
local walkspeed = nil
Carry:addcheckbox("Shift Walkspeed",false,function(b)
    if b then
        --//Variables//
...
local Multiplier = 1.0 --adjust this for more or less speed
...
Carry:addcheckbox("FE Fling Gui",false,function(b)
    if b then
...
Instructions.Text = "Just walk into someone!"
